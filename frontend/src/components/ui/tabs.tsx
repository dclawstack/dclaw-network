...
>(({ className, children, ...props }, ref) => (
  <div ref={ref} className={cn("inline-flex h-10 items-center justify-center rounded-md bg-gray-800 p-1 text-gray-400", className)} {...props}>
    {children}
  </div>
))
...
>(({ className, value, active, setActive, ...props }, ref) => (
  <button
    ...
    className={cn(
      ...
      active === value ? "bg-gray-700 text-white shadow-sm" : "text-gray-400 hover:bg-gray-700/50 hover:text-gray-200",
      className
    )}
    {...props}
  />
