...
**DClaw Network** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8044` (FastAPI)
- **Frontend Port:** `3044` (Next.js)
- **Database:** `dclaw_network` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3044`
